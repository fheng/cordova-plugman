...
function possiblyFetch(actions, platform, project_dir, id, plugins_dir, options) {
    ...
    if (!fs.existsSync(plugin_dir)) {
        ...
        return require('../plugman').raw.fetch(id, plugins_dir, { link: false, subdir: options.subdir, git_ref: options.git_ref, client: 'plugman', expected_id: options.expected_id, searchpath: options.searchpath, cachepath: options.cachepath })
